...
BAND_TO_RECEIVER = {'UWBBand0': 'P170-1',
                    'Cband': 'S60-2',
                    'Xband': 'S36-5',
                    'Sband': 'S110-1',}
...
RCVR_INFO = {'P170-1': 'rcvr:name=P170-1,rcvr:hand=+1,rcvr:basis=lin',
             'P217-3': 'rcvr:name=P217-3,rcvr:hand=-1,rcvr:basis=cir',
             'S110-1': 'rcvr:name=S110-1,rcvr:hand=-1,rcvr:basis=cir',
             'P200-3': 'rcvr:name=P200-3,rcvr:hand=-1,rcvr:basis=cir',
             'S60-2':  'rcvr:name=S60-2,rcvr:hand=-1,rcvr:basis=cir',
